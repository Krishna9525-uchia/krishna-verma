                    ...
                    {results.filter(r => !r.isPrimary).map((res, i) => (
                      <div key={i} className="bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700 relative group/result">
                         <button
                           ...
                           className="absolute top-3 right-3 p-1.5 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors opacity-0 group-hover/result:opacity-100 focus:opacity-100 focus:ring-2 focus:ring-blue-500/50 rounded-md outline-none"
