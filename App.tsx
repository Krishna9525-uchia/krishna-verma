                   ...
                   <div key={`primary-${i}`} className="group/result relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover/result:opacity-100 focus:opacity-100 outline-none focus:ring-2 focus:ring-white/30"
                      ...
                      <div key={`secondary-${i}`} className="group/result relative bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
                         <div className="flex justify-between items-start">
                            ...
                            <button
                              ...
                              className="p-1 rounded-md text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-all opacity-0 group-hover/result:opacity-100 focus:opacity-100 outline-none focus:ring-2 focus:ring-blue-500/50"
                              aria-label={`Copy ${res.label}`}
                            >
