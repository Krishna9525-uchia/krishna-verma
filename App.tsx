...
const CalculatorDetail: React.FC = () => {
  ...
  const copyToClipboard = (text: any, statusKey: string) => {
                   ...
                   <div key={i} className="group/result bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20 relative">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors md:opacity-0 group-hover/result:opacity-100 focus:opacity-100 focus:ring-2 focus:ring-white/50 outline-none"
                          aria-label={copyStatus === `primary-${i}` ? "Copied!" : `Copy ${res.label}`}
                        >
