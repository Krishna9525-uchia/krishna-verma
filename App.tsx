         ...
         <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="relative max-w-2xl mx-auto animate-slide-up" style={{animationDelay: '0.2s'}}>
              <div className="relative group">
                ...
                <div className="relative flex items-center bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden focus-within:ring-2 focus-within:ring-blue-500 transition-all">
                   ...
                   <input 
                    ...
                    {search && (
                      <button
                        onClick={() => setSearch('')}
                        className="pr-6 text-slate-400 hover:text-slate-600 focus:outline-none focus:text-blue-600 transition-colors"
  ...
  return (
    <Router>
      ...
      <div className="flex flex-col min-h-screen font-sans">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:bg-white dark:focus:bg-slate-800 focus:p-4 focus:m-4 focus:rounded-lg focus:shadow-2xl focus:text-blue-600 dark:focus:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold"
        >
