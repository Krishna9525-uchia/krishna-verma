                      ...
                      <div key={i} className="group relative bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
                         <div className="flex justify-between items-start">
                           ...
                           <button
                             ...
                             className="p-1 rounded bg-slate-200 dark:bg-slate-600 hover:bg-slate-300 dark:hover:bg-slate-500 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 text-slate-600 dark:text-slate-300"
                             aria-label={copiedId === `secondary-${i}` ? "Copied!" : "Copy value"}
                           >
