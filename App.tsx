                      ...
                      <div key={i} className="group/result relative bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
                         <div className="flex justify-between items-start">
                            ...
                            <button
                              ...
                              className="p-1 rounded-md text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-all md:opacity-0 group-hover/result:opacity-100 focus:opacity-100 outline-none focus:ring-2 focus:ring-blue-500/30"
