                   ...
                   <div key={i} className="group/result relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20 transition-all">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg bg-white/10 hover:bg-white/20 focus:bg-white/20 outline-none transition-all md:opacity-0 group-hover/result:opacity-100 focus:opacity-100"
