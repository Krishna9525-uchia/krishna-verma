  ...
  return (
    <Router>
      ...
      <div className="flex flex-col min-h-screen font-sans">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded-b-lg focus:left-1/2 focus:-translate-x-1/2 focus:shadow-lg focus:outline-none transition-all"
        >
