                   ...
                   <div key={`primary-${i}`} className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20 relative group">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="p-2 hover:bg-white/10 rounded-lg transition-colors focus:ring-2 focus:ring-white/50 outline-none"
                      ...
                      <div key={i} className="bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700 group/result relative">
                         <div className="flex justify-between items-start">
                            ...
                            <button
                              ...
                              className="p-1.5 opacity-0 group-hover/result:opacity-100 focus:opacity-100 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all focus:ring-2 focus:ring-blue-500/50 rounded-md outline-none"
