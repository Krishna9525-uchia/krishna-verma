...
const SkipToMain = () => {
  ...
  return (
    <a
      href="#main-content"
      onClick={skip}
      className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded-lg focus:shadow-lg outline-none"
    >
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
         ...
         <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="relative max-w-2xl mx-auto animate-slide-up" style={{animationDelay: '0.2s'}}>
              <div className="relative group focus-within:ring-2 focus-within:ring-blue-500/50 rounded-2xl transition-all">
                ...
                <div className="relative flex items-center bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                   ...
                   <input 
                    ...
                    {search && (
                      <button
                        onClick={() => setSearch('')}
                        className="pr-6 text-slate-400 hover:text-slate-600 focus:outline-none focus:text-blue-500 transition-colors"
        ...
        {search ? (
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-8">
               <h2 className="text-2xl font-bold text-slate-900 dark:text-white" aria-live="polite">Search Results</h2>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden animate-slide-up">
             <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
               ...
               }} className="text-xs font-semibold text-blue-600 hover:text-blue-800 uppercase tracking-wide focus-visible:ring-2 focus-visible:ring-blue-500/50 rounded px-1 transition-all outline-none">
                 Reset
               </button>
             </div>
                ...
                <div className="space-y-4">
                  {calculator.article.faqs.map((faq, i) => (
                    <details key={i} className="group bg-slate-50 dark:bg-slate-700/20 rounded-xl overflow-hidden cursor-pointer transition-colors hover:bg-slate-100 dark:hover:bg-slate-700/40">
                      <summary className="p-4 font-semibold text-slate-900 dark:text-white list-none flex justify-between items-center outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 rounded-xl transition-all">
                        {faq.question}
