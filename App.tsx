                   ...
                   <div key={i} className="group/result relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="md:opacity-0 group-hover/result:opacity-100 focus:opacity-100 transition-opacity p-2 hover:bg-white/10 rounded-lg"
                      ...
                      <div key={i} className="group/result relative bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
                         <div className="flex justify-between items-start">
                           ...
                           <button
                             ...
                             className="md:opacity-0 group-hover/result:opacity-100 focus:opacity-100 transition-opacity p-1 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400"
