          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden animate-slide-up" style={{animationDelay: '0.1s'}}>
             ...
             <div className="p-6 space-y-4">
                 ...
                 {results.filter(r => r.isPrimary).map((res, i) => (
                   <div key={i} className="relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20 group/result">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          aria-label={copiedId === `primary-${i}` ? "Copied to clipboard" : `Copy ${res.label}`}
                        >
                      ...
                      <div key={i} className="relative bg-slate-50 dark:bg-slate-700/30 rounded-xl p-4 border border-slate-100 dark:border-slate-700 group/result">
                         <div className="flex justify-between items-start">
                           ...
                           <button
                             ...
                             className="opacity-0 group-hover/result:opacity-100 focus:opacity-100 p-1 rounded-md hover:bg-slate-200 dark:hover:bg-slate-600 transition-all focus:ring-2 focus:ring-blue-500/30 outline-none"
                             aria-label={copiedId === `secondary-${i}` ? "Copied to clipboard" : `Copy ${res.label}`}
                           >
