                   ...
                   <div key={i} className="group relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/20">
                      <div className="flex justify-between items-start">
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 focus-within:opacity-100 p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-all focus:outline-none focus:ring-2 focus:ring-white/50"
